 ...
 *
 * This file handles:
 * - Author and Series database tables
 * - Author management (create, merge, delete, aliases)
 * - Series management
 * - Persistent ID assignment that survives reindexing
 */
 ...
 * Stores unique author records with persistent IDs
 */
...
/**
 * Create the author aliases table
 * Handles multiple name variations for the same author (e.g., R.L. Stine vs Robert Lawrence Stine)
 */
...
/**
 * Create the book-author relationship table
 * Many-to-many relationship: books can have multiple authors, authors can have multiple books
 */
 ...
 * Stores book series information
 */
...
/**
 * Create the book-series relationship table
 * Books can belong to a series with a specific position/volume number
 */
...
/**
 * Create author merge history table
 * Tracks when authors are merged together (for audit purposes)
 */
 ...
 * @param array $args Optional arguments (canonical_name, bio, created_by)
 ...
 *
 * @param string $name_or_slug Author name or slug
 * @return object|null Author object or null if not found
 */
...
/**
 * Add an alias for an author
 *
 * @param int $author_id The author ID
 * @param string $alias_name The alias name
 * @return int|false Alias ID on success, false on failure
 */
