...
function hs_gid_activate()
{
	...
	// ISBN tracking table - supports multiple ISBNs per book/GID
...
// Get or create a GID for a book post
function hs_get_or_create_gid($post_id)
{
	global $wpdb;
	$table = $wpdb -> prefix . 'hs_gid';

	// Check if this post already has a GID entry
	...
	// Create a new GID for this post
	// The GID is the same as the post_id for the first book
...
// =============================================================================
// ISBN MIGRATION FUNCTIONS
// =============================================================================

// Migrate existing ISBNs from ACF fields to the new hs_book_isbns table
